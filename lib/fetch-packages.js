 ...
 */
export async function downloadPackages(packages, options = {}) {
 ...
 */
export function downloadPackageTarball(name, version = 'latest', options = { destFolder: '.', registry: undefined }) {
 ...
 */
export async function resolveDependencies(manifest, options) {
    const logger = options.logger || (() => { });
 ...
 */
export function getPackageManifest(packageName, packageVersion = 'latest', opts = { registry: undefined }) {
